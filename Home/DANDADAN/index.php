...
$animeTitle = 'Dandada'; // Title of the anime
$animeImage = 'https://cdn.myanimelist.net/images/anime/1990/139975l.jpg'; // Poster image URL
$animeDescription = 'Despite their initial clash over their opposing beliefs, Momo and Ken form an unexpected but intimate friendship, a bond forged in a series of supernatural battles and bizarre encounters with urban legends and paranormal entities.';
$animeYear = '2022';
...
<body>
    ...
    <div class="banner">
        ...
        <iframe 
        src="https://www.youtube.com/embed/V3xNYDFsnN8?enablejsapi=1&wmode=opaque&autoplay=1"
        frameborder="0" 
        allowfullscreen 
        class="bg" 
        allow="autoplay">
